...
const Notfound = () => {
  ...
  return (
    <motion.div
      className="flex flex-col items-center justify-center my-6 text-gray-800 dark:text-gray-100"
    ...
    >
      ...
      {/* Animated Message */}
      <motion.p
        className="mt-6 text-xl text-center px-6 max-w-lg font-light leading-relaxed dark:text-gray-300"
        variants={fadeInUp}
      >
      ...
      <motion.a
        href="/"
        className="mt-8 px-8 py-3 bg-slate-600 text-white font-semibold rounded-md shadow-lg hover:bg-slate-700 dark:bg-slate-500 dark:hover:bg-slate-600 transition-all duration-300"
        variants={fadeInUp}
